...
export default function Footer() {
    return (
        <footer className="text-primary flex flex-row justify-between items-center py-10">
            <div className="flex flex-col gap-3">
                <div className="flex flex-row justify-start items-center gap-1 text-md font-bold">
                    ...
                    <span className="flex flex-row justify-start items-center gap-1">Michel de Freitas</span>
                </div>
            ...
            <div className="flex flex-col gap-3">
                <div className="flex flex-row justify-end items-center gap-3 font-bold">
